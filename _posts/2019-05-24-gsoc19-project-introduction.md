...
![Chainer_logo]({{ site.baseurl }}/assets/img/blog/Elichika/chainer_logo.png){:width="600px" style="display: block; margin: 0 auto" }
...
![ONNX_logo]({{ site.baseurl }}/assets/img/blog/Elichika/onnx_logo.png){:width="600px" style="display: block; margin: 0 auto" }
...
![ch2o_design]({{ site.baseurl }}/assets/img/blog/Elichika/elichika_flow.png){:width="800px" style="display: block; margin: 0 auto" }
