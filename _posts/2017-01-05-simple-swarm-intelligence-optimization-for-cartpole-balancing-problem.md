---
layout: post
title:  "Particle Swarm Optimization balancing Cart-Pole"
date:   2017-01-05
description: "Particle Swarm Optimization balancing Cart-Pole"
...
<p align="center"><iframe  allowfullscreen="0" width="640" height="480" src="https://www.youtube.com/embed/PIJICmPDQPU" frameborder="0" allowfullscreen>S</iframe></p>
...
<video autoplay="True"  width="640" height="480"  controls loop preload='metadata' onclick='(function(el){ if(el.paused) el.play(); else el.pause() })(this)'>
  <source src='{{ site.baseurl }}/assets/img/blog/CartPole/pso_balance.mp4' type='video/mp4; codecs="avc1.42E01E, mp4a.40.2"'>
</video>
</p>
<p align="center">Five episodes of the CartPole environment based on a random.</p>
